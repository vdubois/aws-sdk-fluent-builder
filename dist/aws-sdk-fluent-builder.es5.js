...
var S3HostingService = /** @class */ (function () {
    ...
    S3HostingService.prototype.uploadFilesFromDirectory = function (sourceDirectoryPath, destinationPathInBucket) {
        ...
        if (!statSync(sourceDirectoryPath).isDirectory()) {
        ...
        return this.createBucketIfNecesary()
            ...
            Bucket: _this.bucketName,
            Key: destinationPathInBucket + file.substring(normalize(sourceDirectoryPath).length + 1),
    ...
    S3HostingService.prototype.exposeBucketAsPublicWebsite = function () {
        var _this = this;
        var policyContent = readFileSync(__dirname + '/s3-hosting.policy.json').toString();
    ...
    S3HostingService.prototype.walkDirectorySync = function (directoryPath, filelist) {
        ...
        return readdirSync(directoryPath)
            .map(function (filePath) { return statSync(join(directoryPath, filePath)).isDirectory()
            ? _this.walkDirectorySync(join(directoryPath, filePath), filelist)
            : filelist.concat(join(directoryPath, filePath))[0]; });
    };
...
export { DynamoDbBuilder, DynamoDbRepositoryImplementation, DynamoDbRepositoryProxy, S3Builder, S3ConfigurationBuilder, S3HostingBuilder, S3StorageBuilder, S3ConfigurationService, S3HostingService, S3StorageService, SnsBuilder, SnsImplementation, SnsProxy };
//# sourceMappingURL=aws-sdk-fluent-builder.es5.js.map
